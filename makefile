...
_OBJS = HPTime.o Pacman.o Terrain.o Mat4.o Vec2.o Vec3.o Vec4.o Primitives.o Loader.o StringFunctions.o GameEntity.o Game.o PacmanGame.o Camera.o Food.o Ghost.o HUD.o BoundingBox.o
